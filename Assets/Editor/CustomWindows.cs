...
#region Option Panel
            ...
            if (showOptions)
            {
                ...
                EditorGUILayout.BeginVertical(style_2);
                {
                    ...
                    PersistantSettings.Instance.Scale = EditorGUILayout.Slider("Global scale", PersistantSettings.Instance.Scale, 0.0001f, 1);
                    ...
                    PersistantSettings.Instance.DebugObjectCulling = EditorGUILayout.Toggle("Debug Culling", PersistantSettings.Instance.DebugObjectCulling);
                    EditorGUI.indentLevel--;
                    EditorGUILayout.Space();
